...
from pyrake.linkextractor import FilteringLinkExtractor
from pyrake.utils.misc import arg_to_iter
from pyrake.utils.python import unique as unique_list, str_to_unicode
from pyrake.utils.response import get_base_url
...
class BaseSgmlLinkExtractor(SGMLParser):
    ...
    def __init__(self, tag="a", attr="href", unique=False, process_value=None):
        warnings.warn(
            ...
            "Please use pyrake.contrib.linkextractors.LinkExtractor",
            pyrakeDeprecationWarning
        )
