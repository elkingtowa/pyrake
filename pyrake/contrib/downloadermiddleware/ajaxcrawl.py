...
from pyrake.utils.response import _noscript_re, _script_re
...
class AjaxCrawlMiddleware(object):
    ...
    def __init__(self, settings):
        ...
        # XXX: Google parses at least first 100k bytes; pyrake's redirect
    ...
    def process_response(self, request, response, spider):
        ...
        # pyrake already handles #! links properly
