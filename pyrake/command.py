"""
Base class for pyrake commands
"""
import os
import warnings
...
from pyrake.utils.conf import arglist_to_dict
from pyrake.exceptions import UsageError, pyrakeDeprecationWarning


class pyrakeCommand(object):
    ...
    def __init__(self):
        self.settings = None  # set in pyrake.cmdline
