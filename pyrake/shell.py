...
from pyrake.exceptions import IgnoreRequest, pyrakeDeprecationWarning
...
from pyrake.utils.console import start_python_console
from pyrake.utils.misc import load_object
from pyrake.utils.response import open_in_browser
from pyrake.utils.spider import create_spider_for_request
...
class Shell(object):
    ...
    def print_help(self):
        self.p("Available pyrake objects:")
...
class _SelectorProxy(object):
    ...
    def __getattr__(self, name):
        warnings.warn('"sel" shortcut is deprecated. Use "response.xpath()", '
                      ...
                      category=pyrakeDeprecationWarning, stacklevel=2)
