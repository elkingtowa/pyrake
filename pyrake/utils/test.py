...
def get_pythonpath():
    ...
    installation of pyrake"""
    pyrake_path = import_module('pyrake').__path__[0]
    return os.path.dirname(pyrake_path) + os.pathsep + os.environ.get('PYTHONPATH', '')

def get_testenv():
    """Return a OS environment dict suitable to fork processes that need to import
    this installation of pyrake, instead of a system installed one.
    """
    env = os.environ.copy()
...
def get_testlog():
    """Get pyrake log of current test, ignoring the rest"""
