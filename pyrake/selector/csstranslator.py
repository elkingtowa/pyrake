...
class pyrakeXPathExpr(XPathExpr):
    ...
    def __str__(self):
        path = super(pyrakeXPathExpr, self).__str__()
        if self.textnode:
            if path == '*':
                path = 'text()'
            elif path.endswith('::*/*'):
    ...
    def join(self, combiner, other):
        super(pyrakeXPathExpr, self).join(combiner, other)
...
class TranslatorMixin(object):
    ...
    def xpath_element(self, selector):
        ...
        return pyrakeXPathExpr.from_xpath(xpath)
    ...
    def xpath_text_simple_pseudo_element(self, xpath):
        ...
        return pyrakeXPathExpr.from_xpath(xpath, textnode=True)


class pyrakeGenericTranslator(TranslatorMixin, GenericTranslator):
    pass


class pyrakeHTMLTranslator(TranslatorMixin, HTMLTranslator):
    pass
