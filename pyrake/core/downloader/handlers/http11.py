...
from pyrake.xlib.tx import Agent, ProxyAgent, ResponseDone, \
    HTTPConnectionPool, TCP4ClientEndpoint

from pyrake.http import Headers
from pyrake.responsetypes import responsetypes
from pyrake.core.downloader.webclient import _parse
...
class HTTP11DownloadHandler(object):
    ...
    def download_request(self, request, spider):
        ...
        agent = pyrakeAgent(contextFactory=self._contextFactory, pool=self._pool)
