...
from pyrake.http import Response, XmlResponse
from pyrake.contrib_exp.downloadermiddleware.decompression import DecompressionMiddleware
from pyrake.spider import Spider
from tests import get_testdata
from pyrake.utils.test import assert_samelines
