...
from pyrake.utils.test import docrawl, get_testlog
from tests.mockserver import MockServer
from pyrake.http import Response, Request
from pyrake.spider import Spider
from pyrake.contrib.spidermiddleware.httperror import HttpErrorMiddleware, HttpError
...
class TestHttpErrorMiddleware(TestCase):
    ...
    def test_handle_httpstatus_list(self):
        ...
        res.request = Request('http://pyraketest.org',
