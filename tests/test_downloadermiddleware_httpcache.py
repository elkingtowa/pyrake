...
from pyrake.http import Response, HtmlResponse, Request
...
from pyrake.contrib.downloadermiddleware.httpcache import HttpCacheMiddleware


class _BaseTest(unittest.TestCase):

    storage_class = 'pyrake.contrib.httpcache.DbmCacheStorage'
    policy_class = 'pyrake.contrib.httpcache.RFC2616Policy'
...
class FilesystemStorageTest(DefaultStorageTest):
    ...
    storage_class = 'pyrake.contrib.httpcache.FilesystemCacheStorage'


class LeveldbStorageTest(DefaultStorageTest):

    pytest.importorskip('leveldb')
    storage_class = 'pyrake.contrib.httpcache.LeveldbCacheStorage'


class DummyPolicyTest(_BaseTest):

    policy_class = 'pyrake.contrib.httpcache.DummyPolicy'
