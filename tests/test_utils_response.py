...
from pyrake.http import Response, TextResponse, HtmlResponse
from pyrake.utils.response import response_httprepr, open_in_browser, get_meta_refresh

__doctests__ = ['pyrake.utils.response']
