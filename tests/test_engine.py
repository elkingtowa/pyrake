...
from pyrake.xlib.pydispatch import dispatcher
...
from pyrake.utils.signal import disconnect_all
...
class TestSpider(Spider):
    name = "pyraketest.org"
    allowed_domains = ["pyraketest.org", "localhost"]
...
class EngineTest(unittest.TestCase):
    ...
    def _assert_signals_catched(self):
        ...
        self.run.signals_catched[signals.spider_closed].pop('spider_stats', None) # XXX: remove for pyrake 0.17
