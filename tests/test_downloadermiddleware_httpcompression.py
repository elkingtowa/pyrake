...
from pyrake.http import Response, Request, HtmlResponse
from pyrake.contrib.downloadermiddleware.httpcompression import HttpCompressionMiddleware
...
class HttpCompressionTest(TestCase):
    ...
    def _getresponse(self, coding):
        ...
        response = Response('http://pyraketest.org/', body=body, headers=headers)
        response.request = Request('http://pyraketest.org', headers={'Accept-Encoding': 'gzip,deflate'})
        return response
    ...
    def test_process_response_plain(self):
        response = Response('http://pyraketest.org', body='<!DOCTYPE...')
        request = Request('http://pyraketest.org')
