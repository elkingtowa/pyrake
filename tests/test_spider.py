...
import inspect
import warnings
from pyrake.utils.trackref import object_ref
from io import BytesIO

from twisted.trial import unittest

from pyrake.spider import Spider, BaseSpider
from pyrake.http import Request, Response, TextResponse, XmlResponse, HtmlResponse
from pyrake.contrib.spiders.init import InitSpider
from pyrake.contrib.spiders import CrawlSpider, Rule, XMLFeedSpider, \
...
class BaseSpiderDeprecationTest(unittest.TestCase):
    ...
    def test_basespider_is_deprecated(self):
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertEqual(w[0].category, pyrakeDeprecationWarning)
