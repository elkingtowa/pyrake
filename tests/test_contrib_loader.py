...
from pyrake.contrib.loader.processor import Join, Identity, TakeFirst, \
    Compose, MapCompose
...
class BasicItemLoaderTest(unittest.TestCase):
    ...
    def test_map_compose_filter(self):
        ...
        self.assertEqual(proc(['hello', 'world', 'this', 'is', 'pyrake']),
                         ['HELLO', 'THIS', 'IS', 'pyrake'])
    ...
    def test_input_processor_inheritance(self):
        ...
        il = ChildItemLoader()
        il.add_value('url', u'HTTP://pyrake.ORG')
        self.assertEqual(il.get_output_value('url'), [u'http://pyrake.org'])
        il.add_value('name', u'marta')
        self.assertEqual(il.get_output_value('name'), [u'Marta'])
...
class ProcessorsTest(unittest.TestCase):
    ...
    def test_mapcompose(self):
        ...
        self.assertEqual(proc([u'hello', u'world', u'this', u'is', u'pyrake']),
...
class SelectortemLoaderTest(unittest.TestCase):
    ...
    <div id="id">marta</div>
    <p>paragraph</p>
    <a href="http://www.pyrake.org">homepage</a>
    <img src="/images/logo.png" width="244" height="65" alt="pyrake">
    </body>
    </html>
    """)
    ...
    def test_constructor_with_response_css(self):
        ...
        self.assertEqual(l.get_output_value('url'), [u'http://www.pyrake.org'])
        ...
        self.assertEqual(l.get_output_value('url'), [u'http://www.pyrake.org', u'/images/logo.png'])
    ...
    def test_add_css_re(self):
        ...
        self.assertEqual(l.get_output_value('url'), [u'www.pyrake.org'])
    ...
    def test_get_css(self):
        ...
        self.assertEqual(l.get_css(['a::attr(href)', 'img::attr(src)']),
            [u'http://www.pyrake.org', u'/images/logo.png'])
    ...
    def test_replace_css_re(self):
        ...
        self.assertEqual(l.get_output_value('url'), [u'pyrake.org'])
