...
from pyrake.utils.misc import load_object, arg_to_iter, walk_modules

__doctests__ = ['pyrake.utils.misc']

class UtilsMiscTestCase(unittest.TestCase):

    def test_load_object(self):
        obj = load_object('pyrake.utils.misc.load_object')
        assert obj is load_object
        self.assertRaises(ImportError, load_object, 'nomodule999.mod.function')
        self.assertRaises(NameError, load_object, 'pyrake.utils.misc.load_object999')
