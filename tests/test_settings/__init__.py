...
from pyrake.settings import Settings, SettingsAttribute, CrawlerSettings
...
class SettingsTest(unittest.TestCase):
    ...
    @mock.patch.dict('pyrake.settings.SETTINGS_PRIORITIES', {'default': 10})
    @mock.patch('pyrake.settings.default_settings', default_settings)
    ...
    @mock.patch.dict('pyrake.settings.SETTINGS_PRIORITIES', {})
    @mock.patch('pyrake.settings.default_settings', {})
