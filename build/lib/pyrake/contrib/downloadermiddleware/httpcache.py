...
from pyrake.contrib.httpcache import FilesystemCacheStorage as _FilesystemCacheStorage
class FilesystemCacheStorage(_FilesystemCacheStorage):
    ...
    def __init__(self, *args, **kwargs):
        ...
        warnings.warn('Importing FilesystemCacheStorage from '
                      'pyrake.contrib.downloadermiddlware.httpcache is '
                      'deprecated, use pyrake.contrib.httpcache instead.',
