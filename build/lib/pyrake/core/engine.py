"""
This is the pyrake engine which controls the Scheduler, Downloader and Spiders.
...
from pyrake.core.downloader import Downloader
from pyrake.core.scraper import Scraper
from pyrake.exceptions import DontCloseSpider, pyrakeDeprecationWarning
from pyrake.http import Response, Request
from pyrake.utils.misc import load_object
from pyrake.utils.reactor import CallLaterOnce
    ...
    def __init__(self, crawler, spider_closed_callback):
        ...
        if self._concurrent_spiders != 1:
            warnings.warn("CONCURRENT_SPIDERS settings is deprecated, use " \
                "pyraked max_proc config instead", pyrakeDeprecationWarning)
