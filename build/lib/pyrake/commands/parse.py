...
from pyrake.utils import display
from pyrake.utils.conf import arglist_to_dict
from pyrake.utils.spider import iterate_spider_output, create_spider_for_request
...
class Command(pyrakeCommand):
    ...
    def process_options(self, args, opts):
        pyrakeCommand.process_options(self, args, opts)
        try:
