...
The spider middleware is a framework of hooks into pyrake's spider processing
...
:setting:`SPIDER_MIDDLEWARES_BASE` setting defined in pyrake (and not meant to
...
value.  For example, if you want to disable the off-site middleware::
    ...
    SPIDER_MIDDLEWARES = {
        'myproject.middlewares.CustomSpiderMiddleware': 543,
        'pyrake.contrib.spidermiddleware.offsite.OffsiteMiddleware': None,
    }
...
.. module:: pyrake.contrib.spidermiddleware
...
.. class:: SpiderMiddleware
    ...
    .. method:: process_spider_input(response, spider)
        ...
        If it returns ``None``, pyrake will continue processing this response,
        executing all other middlewares until, finally, the response is handed
        to the spider for processing.

        If it raises an exception, pyrake won't bother calling any other spider
    ...
    .. method:: process_spider_output(response, result, spider)
        ...
        :class:`~pyrake.http.Request` or :class:`~pyrake.item.Item` objects.
        ...
        :type result: an iterable of :class:`~pyrake.http.Request` or
          :class:`~pyrake.item.Item` objects

        :param spider: the spider whose result is being processed
        :type spider: :class:`~pyrake.item.Spider` object
    ...
    .. method:: process_spider_exception(response, exception, spider)
        ...
        iterable of :class:`~pyrake.http.Response` or
        :class:`~pyrake.item.Item` objects.
    ...
    .. method:: process_start_requests(start_requests, spider)
        ...
        return another iterable of :class:`~pyrake.http.Request` objects.
        ...
        .. note:: When implementing this method in your spider middleware, you
           ...
           large (or even unbounded) and cause a memory overflow. The pyrake
        ...
        :type start_requests: an iterable of :class:`~pyrake.http.Request`
...
This page describes all spider middleware components that come with pyrake. For
...
.. module:: pyrake.contrib.spidermiddleware.depth
...
.. module:: pyrake.contrib.spidermiddleware.httperror
...
<pyrake.http.Request.meta>` can also be used to specify which response codes to
...
.. module:: pyrake.contrib.spidermiddleware.offsite
...
.. class:: OffsiteMiddleware
   ...
   spider's :attr:`~pyrake.spider.Spider.allowed_domains` attribute.
   ...
   :attr:`~pyrake.spider.Spider.allowed_domains` attribute, or the
   attribute is empty, the offsite middleware will allow all requests.

   If the request has the :attr:`~pyrake.http.Request.dont_filter` attribute
...
.. module:: pyrake.contrib.spidermiddleware.referer
...
.. module:: pyrake.contrib.spidermiddleware.urllength
