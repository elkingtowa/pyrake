...
library, pyrake provides its own facility for sending e-mails which is very
...
the standard constructor::
    ...
    from pyrake.mail import MailSender
    mailer = MailSender()

Or you can instantiate it passing a pyrake settings object, which will respect
...
MailSender is the preferred class to use for sending emails from pyrake, as it
...
.. class:: MailSender(smtphost=None, mailfrom=None, smtpuser=None, smtppass=None, smtpport=None)
    ...
    .. classmethod:: from_settings(settings)
        ...
        Instantiate using a pyrake settings object, which will respect
        :ref:`these pyrake settings <topics-email-settings>`.

        :param settings: the e-mail recipients
        :type settings: :class:`pyrake.settings.Settings` object
