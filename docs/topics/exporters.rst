...
.. module:: pyrake.contrib.exporter
...
For this purpose pyrake provides a collection of Item Exporters for different
...
Exporter to export scraped items to different files, one per spider::
   ...
   from pyrake.contrib.exporter import XmlItemExporter
...
Example::
    ...
    class Product(pyrake.Item):
        name = pyrake.Field()
        price = pyrake.Field(serializer=serialize_price)
...
Here is a list of the Item Exporters bundled with pyrake. Some of them contain
...
.. class:: BaseItemExporter(fields_to_export=None, export_empty_fields=False, encoding='utf-8')
   ...
   .. method:: serialize_field(field, name, value)
      ...
      :type field: :class:`~pyrake.item.Field` object
