...
pyrake comes with a simple benchmarking suite that spawns a local HTTP server
and crawls it at the maximum possible speed. The goal of this benchmarking is
to get an idea of how pyrake performs in your hardware, in order to have a
...
You should see an output like this::
    ...
    2013-05-16 13:08:46-0300 [pyrake] INFO: pyrake 0.17.0 started (bot: pyrakebot)
    ...
    2013-05-16 13:08:57-0300 [follow] INFO: Dumping pyrake stats:
...
That tells you that pyrake is able to crawl about 3900 pages per minute in the
