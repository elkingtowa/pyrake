...
chapter <topics-items>`::
    ...
    from pyrake.contrib.loader import ItemLoader
...
:class:`~pyrake.item.Item` object.  That's when the output processor is
...
Last, but not least, pyrake comes with some :ref:`commonly used processors
...
is an example::
    ...
    from pyrake.contrib.loader import ItemLoader
    from pyrake.contrib.loader.processor import TakeFirst, MapCompose, Join
...
metadata. Here is an example::
    ...
    import pyrake
    from pyrake.contrib.loader.processor import Join, MapCompose, TakeFirst
...
.. class:: ItemLoader([item, selector, response], \**kwargs)
    ...
    :type selector: :class:`~pyrake.selector.Selector` object
    ...
    .. method:: get_value(value, \*processors, \**kwargs)
        ...
        :param re: a regular expression to use for extracting data from the
            given value using :meth:`~pyrake.utils.misc.extract_regex` method,
            applied before processors
        :type re: str or compiled regex

        Examples::

            >>> from pyrake.contrib.loader.processor import TakeFirst
    ...
    .. attribute:: item
        ...
        The :class:`~pyrake.item.Item` object being parsed by this Item Loader.
    ...
    .. attribute:: selector
        ...
        The :class:`~pyrake.selector.Selector` object to extract data from.
...
Product Item Loader (``ProductLoader``)::
    ...
    from pyrake.contrib.loader.processor import MapCompose
...
projects. pyrake only provides the mechanism; it doesn't impose any specific
...
.. module:: pyrake.contrib.loader.processor
   :synopsis: A collection of processors to use with Item Loaders

Even though you can use any callable function as input and output processors,
pyrake provides some commonly used processors, which are described below. Some
...
.. class:: Identity
    ...
    Example::
        ...
        >>> from pyrake.contrib.loader.processor import Identity
        >>> proc = Identity()
        >>> proc(['one', 'two', 'three'])
        ['one', 'two', 'three']
...
.. class:: Join(separator=u' ')
    ...
    Examples::
        ...
        >>> from pyrake.contrib.loader.processor import Join
        >>> proc = Join()
        >>> proc(['one', 'two', 'three'])
        u'one two three'
        >>> proc = Join('<br>')
...
.. class:: Compose(\*functions, \**default_loader_context)
    ...
    Example::
        ...
        >>> from pyrake.contrib.loader.processor import Compose
...
.. class:: MapCompose(\*functions, \**default_loader_context)
    ...
    :meth:`~pyrake.selector.Selector.extract` method of :ref:`selectors
    ...
    The example below should clarify how it works::
        ...
        >>> proc([u'hello', u'world', u'this', u'is', u'pyrake'])
        [u'HELLO, u'THIS', u'IS', u'pyrake']
