...
.. note:: This is a new feature (introduced in pyrake 0.15) and may be subject
   to minor functionality/API updates. Check the :ref:`release notes <news>` to
   be notified of updates.

Testing spiders can get particularly annoying and while nothing prevents you
from writing unit tests the task gets cumbersome quickly. pyrake offers an
...
.. module:: pyrake.contracts.default
...
If you find you need more power than the built-in pyrake contracts you can
...
Each contract must inherit from :class:`pyrake.contracts.Contract` and can
override three methods:

.. module:: pyrake.contracts
...
.. class:: Contract(method, \*args)
    ...
    .. method:: Contract.adjust_request_args(args)
        ...
        for :class:`~pyrake.http.Request` object. Must return the same or a
...
response received. Raise :class:`pyrake.exceptions.ContractFail` in order to
get the failures pretty printed::

    from pyrake.contracts import Contract
    from pyrake.exceptions import ContractFail
