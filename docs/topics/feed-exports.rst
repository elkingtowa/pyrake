...
pyrake provides this functionality out of the box with the Feed Exports, which
 ...
 * Exporter used: :class:`~pyrake.contrib.exporter.JsonItemExporter`
 ...
 * Exporter used: :class:`~pyrake.contrib.exporter.JsonLinesItemExporter`
 ...
 * Exporter used: :class:`~pyrake.contrib.exporter.CsvItemExporter`
 ...
 * Exporter used: :class:`~pyrake.contrib.exporter.XmlItemExporter`
 ...
 * Exporter used: :class:`~pyrake.contrib.exporter.PickleItemExporter`
 ...
 * Exporter used: :class:`~pyrake.contrib.exporter.MarshalItemExporter`
...
The feeds are written to the standard output of the pyrake process.
...
.. currentmodule:: pyrake.contrib.feedexport
...
A dict containing the built-in feed storage backends supported by pyrake.
...
A dict containing the built-in feed exporters supported by pyrake.
