...
pyrake comes with a built-in telnet console for inspecting and controlling a
pyrake running process. The telnet console is just a regular python shell
running inside the pyrake process, so you can do literally anything from it.

The telnet console is a :ref:`built-in pyrake extension
...
The telnet console is like a regular Python shell running inside the pyrake
...
+================+===================================================================+
| ``crawler``    | the pyrake Crawler (:class:`pyrake.crawler.Crawler` object)       |
+----------------+-------------------------------------------------------------------+
...
+----------------+-------------------------------------------------------------------+
| ``settings``   | the pyrake settings object (Crawler.settings attribute)           |
+----------------+-------------------------------------------------------------------+
...
You can use the ``est()`` method of the pyrake engine to quickly show its state
...
Pause, resume and stop the pyrake engine
----------------------------------------
