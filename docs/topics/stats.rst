...
pyrake provides a convenient facility for collecting stats in the form of
key/values, where values are often counters. The facility is called the Stats
Collector, and can be accessed through the :attr:`~pyrake.crawler.Crawler.stats`
...
collecting stats in your spider, pyrake extension, or whatever code you're
...
Access the stats collector through the :attr:`~pyrake.crawler.Crawler.stats`
...
available in pyrake which extend the basic Stats Collector. You can select
...
.. class:: MemoryStatsCollector
    ...
    This is the default Stats Collector used in pyrake.
...
.. class:: DummyStatsCollector
    ...
    other pyrake workload like parsing pages.
