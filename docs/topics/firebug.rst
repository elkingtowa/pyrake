...
The :class:`~pyrake.contrib.spiders.Rule` object instructs
:class:`~pyrake.contrib.spiders.CrawlSpider` based spiders how to follow the
...
use the :ref:`pyrake shell <topics-shell>` to test those XPath's and make sure
...
It's important to use the :ref:`pyrake shell <topics-shell>` to test these
